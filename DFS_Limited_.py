# created by chandima
# This to visualize the Enemy , Hero , kids and walls with DFS limited algorithm
...
DEPTH_LIMIT = 100  # maximum depth limit
...
pygame.display.set_caption("DFS Limited Algorithm")
