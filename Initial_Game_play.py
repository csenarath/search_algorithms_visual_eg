# created by chandima
# This to visualize the Enemy , Hero , kids and walls
...
flags_s = DOUBLEBUF  # set double  buffer for frames. (pygame frame property)

pygame.init()  # start  pygame
clock = pygame.time.Clock()

MOVING_TIME_TICK = 0.3  # enemy moving speed
WAIT_BEFORE_START= 5  # waiting time before start
...
pygame.display.set_caption("Initial Game Play")
...
class Map(object):
    ...
    Enemy = Objects("Enemy", "Enemy", 13, 5, RED_2, 1, 0)
...
# Enemy move class for just to keep it in memory
...
initial_screen()  # draw grid as initial screen
